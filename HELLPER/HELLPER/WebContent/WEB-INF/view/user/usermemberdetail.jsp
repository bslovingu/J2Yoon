		...
		<div class="container">
			...
			<div class="row">
				<form name="sentMessage"
					action="/usermember/updateusermemberinfo.do" method="post">
				...
				<a
					href="/usermember/userdeletemember.do?mem_seq=<%=detail.getMem_seq()%>"><button
						class="btn btn-success btn-lg">Delete</button></a> <a
					href="/usermember/userchpassword.do"><button
						class="btn btn-success btn-lg">비밀번호 변경</button></a>
			</div>
		</div>
	</section>
