...
<body id="page-top" class="index">
    ...
    <!-- About Section -->
    <section class="success" id="idsearch">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>아이디찾기</h2>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <!-- To configure the contact form email address, go to mail/contact_me.php and update the email address in the PHP file on line 19. -->
                    <!-- The form should work on most web servers, but if the form is not working you may need to configure your web server differently. -->
                    <form name="sentMessage" id="contactForm" action="/member/idsearch_proc.do" method="post" novalidate>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Name</label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <input type="button" class="btn btn-success btn-lg" onclick="javascript:sendidsearch()" value="send">
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <!-- To configure the contact form email address, go to mail/contact_me.php and update the email address in the PHP file on line 19. -->
                    <!-- The form should work on most web servers, but if the form is not working you may need to configure your web server differently. -->
                    <form name="sentMessage" action="/member/passwordsearch_proc.do" method="post" novalidate>
                    	<div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>NAME</label>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>phone</label>
                                <input type="text" class="form-control" placeholder="phone" name="phone" required data-validation-required-message="Please enter your phonenumber">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <br>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <!-- To configure the contact form email address, go to mail/contact_me.php and update the email address in the PHP file on line 19. -->
                    <!-- The form should work on most web servers, but if the form is not working you may need to configure your web server differently. -->
                    <form name="sentMessage" action="/member/regproc.do" method="post">
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Name</label>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>cm</label>
                                <input type="cm" class="form-control" placeholder="cm" name="cm" required data-validation-required-message="Please enter your cm">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>kg</label>
                                <input type="text" class="form-control" placeholder="kg" name="kg" required data-validation-required-message="Please enter your kg">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <br>
...
<script type="text/javascript">
	function sendidsearch(){
		var name = opener.document.getElementById("name");
		var phone = opener.document.getElementById("phone");
		location.href="/member/idsearch_proc.do?name=" + name + "&phone=" + phone; 
	}
