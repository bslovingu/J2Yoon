		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll"><a href="#userInfo">UserInfo</a></li>
					<li class="page-scroll"><a href="#BMI">이용 현황</a></li>
					<li class="page-scroll"><a href="/admin/NoticeList.do">커뮤니티</a>
					</li>
					<li class="page-scroll"><a href="/member/logout.do"><font
							size="2">logout</font></a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="container" style="margin: auto; text-align: center;">
			...
			<div class="row">
				...
				<div class="div_content_container"
					...
					%>
					<div style="display: table-row;">
						<div class="table_1st div_content_box"><%=mlist.get(i).getMem_seq()%></div>
				...
				<div class="pagingBox"
					...
					<ul style="list-style: none;">
						...
						%>
						<li><span><a href="/admin/adminmain.do?MPgNum=<%=i%>"><%=i%></a></span></li>
						<%
							}
						%>
						<%
			...
			%>
			<form name="sentMessage" action="/member/updatememberinfo.do"
				method="post">
				<div class="row control-group">
					<div
						class="form-group col-xs-12 floating-label-form-group controls">
						<label>Name</label> <input type="text" class="form-control"
							placeholder="Name" name="name" value="<%=detail.getName()%>"
							required
							data-validation-required-message="Please enter your name.">
						<input type="hidden" name="mem_seq"
							value="<%=detail.getMem_seq()%>">
				...
				<div class="row control-group">
					<div
						...
						<label>Email Address</label> <input type="email"
							...
							value="<%=detail.getEmail()%>" required
				...
				<div class="row control-group">
					<div
						...
						<label>Phone Number</label> <input type="tel" class="form-control"
							...
							value="<%=detail.getPhone()%>" required
				...
				<button type="button" class="btn btn-success btn-lg"
					onclick="location.href='/member/setmemberstop.do?mem_seq=<%=detail.getMem_seq()%>'">활동정지</button>
				<%}else if(detail.getStatus().equals("1")){  %>
				<button type="button" class="btn btn-success btn-lg"
					onclick="location.href='/member/setmemberstart.do?mem_seq=<%=detail.getMem_seq()%>'">정지해제</button>
				<%} %>
				<button type="button" class="btn btn-success btn-lg"
					onclick="location.href='/member/deletemember.do?mem_seq=<%=detail.getMem_seq()%>'">Delete</button>
				<button type="button" class="btn btn-success btn-lg"
					onclick="location.href='/member/memberchpassword.do?mem_seq=<%=detail.getMem_seq()%>'">비밀번호
					변경</button>
