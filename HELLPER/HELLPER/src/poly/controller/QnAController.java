...
public class QnAController {
	...
	public String qnaReg(HttpServletRequest request, HttpServletResponse response, Model model, HttpSession session) throws Exception{
	...
	public String qnaRegProc(HttpServletRequest request, HttpServletResponse response, Model model, HttpSession session) throws Exception{
	...
	public String qnADetail(HttpServletResponse response, HttpServletRequest request, Model model, HttpSession session) throws Exception{
		// 공지사항 갯수 조회
		int NPgNum = 0;
		if (request.getParameter("NPgNum") == null) {
			NPgNum = 1;
	...
	public String qnaDelete(HttpServletRequest request, HttpServletResponse response, Model model, HttpSession session) throws Exception{
		// 공지사항 갯수 조회
		int NPgNum = 0;
		if (request.getParameter("NPgNum") == null) {
			NPgNum = 1;
	...
	public String qnAUpdateForm(HttpServletRequest request, HttpServletResponse response, Model model, HttpSession session) throws Exception{
	...
	public String qnAUpdateProc(HttpServletRequest request, HttpServletResponse response, Model model, HttpSession session) throws Exception{
		// 공지사항 갯수 조회
				int NPgNum = 0;
				if (request.getParameter("NPgNum") == null) {
					NPgNum = 1;
