...
<%
	...
	CountDTO rDTO = (CountDTO) request.getAttribute("rDTO");
%>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll"><a
						href="/usermember/getusermemberdetail.do?mem_seq=<%=user_seq%>">UserInfo</a></li>
					<li class="page-scroll"><a
...
var num10 = "<%=rDTO.getNum10()%>";
var num11 = "<%=rDTO.getNum11()%>";
var num12 = "<%=rDTO.getNum12()%>";
var num13 = "<%=rDTO.getNum13()%>";
var num14 = "<%=rDTO.getNum14()%>";
var num15 = "<%=rDTO.getNum15()%>";
var num16 = "<%=rDTO.getNum16()%>";
var num17 = "<%=rDTO.getNum17()%>";
var num18 = "<%=rDTO.getNum18()%>";
var num19 = "<%=rDTO.getNum19()%>";
var num20 = "<%=rDTO.getNum20()%>";
var num21 = "<%=rDTO.getNum21()%>";
var num22 = "<%=rDTO.getNum22()%>";
var num23 = "<%=rDTO.getNum23()%>";
var num24 = "<%=rDTO.getNum24()%>";
...
<script>
      var chartLabels = ["X-게임장", "간이운동장", "게이트볼장", "골프연습장", "구기체육관", 
    	  "국궁장", "농구장", "다목적운동장", "레이싱경기장", "론볼장", 
    	  "배구장", "배드민턴장", "빙상장", "사격장", "산악자전거체험장",
    	  "생활체육관", "수영장", "스크린사격장", "야구장", "양궁장",
    	  "육상경기장", "인라인스케이트장", "족구장", "축구장", "클라이밍장",
    	  "탁구장", "테니스장", "풋살장", "학교체육시설"];
      ...
      var num23 = "<%=rDTO.getNum23()%>";
      var num24 = "<%=rDTO.getNum24()%>";
      var num25 = "<%=rDTO.getNum25()%>";
      var num26 = "<%=rDTO.getNum26()%>";
      var num27 = "<%=rDTO.getNum27()%>";
      var num28 = "<%=rDTO.getNum28()%>";
      
      var chartData = [num0, num1, num2, num3, num4, num5, num6, num7,
          num8, num9,num10, num11, num12, num13, num14, num15, num16, num17,
          num18, num19,num20, num21, num22, num23, num24, num25, num26, num27, num28];
		...
		data : {
			...
			datasets : [ {
				...
				backgroundColor : [ "#00AF50", "#E83D36", "#A6A6A6",
                    ...
                    "#FF7F00", "#924B0D", "#01B0F1", "#FECF37",
                    "#92D051", "#0170C1", "#7F53AA", "#00AF50", "#E83D36", "#A6A6A6",
                    "#FF7F00", "#924B0D", "#FEA000", "#E8870C", "#E87C0C",
					"#FF710D" ],
				hoverBackgroundColor : [ "#00AF50", "#E83D36", "#A6A6A6",
                    "#FF7F00", "#924B0D", "#01B0F1", "#FECF37",
                    "#92D051", "#0170C1", "#7F53AA", "#00AF50", "#E83D36", "#A6A6A6",
