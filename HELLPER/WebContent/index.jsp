    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">HELLPER</a>
            </div>
                    ...
                    <form name="memreg" action="/member/regproc.do" method="post" onsubmit="return doSubmit(this);">
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="tel" class="form-control" placeholder="Phone Number" name="phone" required data-validation-required-message="Please enter your phone number." onkeypress="InpuOnlyNumber(this)">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>Location</h3>
                        <p>경기도 성남시 분당구 서현동 효자촌 화성 아파트 607동 701호</p>
                    </div>
                    <div class="footer-col col-md-4">
